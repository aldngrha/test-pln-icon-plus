...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Buat Unit PLN Baru</div>
                    <div class="card-body">
                        <form action="{{ route('unitPln.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="nama_unit">Nama Unit:</label>
                                <input type="text" class="form-control" id="unit_pln_name" name="unit_pln_name">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary">Buat Unit PLN</button>
                        </form>
                    </div>
                </div>
            </div>
